...
$total_edukasi         = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM edukasi"))['total'];
...
$total_admin           = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM users"))['total'];


$edukasi_terakhir = mysqli_query($koneksi, "SELECT * FROM edukasi ORDER BY tanggal_posting DESC LIMIT 3");
?>
...
<div class="container-fluid">
    ...
    <div class="dashboard-cards">
        ...
        <div class="card-box">
            ...
            <div class="card-count"><?php echo $total_berita; ?></div>
            <a href="berita_data.php" class="btn btn-sm btn-warning" style="margin-top:10px;">Lihat Berita</a>
        </div>

        
        <div class="card-box">
            <div class="card-icon text-warning">📚</div>
            <div class="card-title">Total Edukasi</div>
            <div class="card-count"><?php echo $total_edukasi; ?></div>
            <a href="edukasi_data.php" class="btn btn-sm btn-warning" style="margin-top:10px;">Lihat Edukasi</a>
        </div>
     
        <div class="card-box">
            <div class="card-icon text-warning">👨‍💻</div>
            <div class="card-title">Daftar Users</div>
            <div class="card-count"><?php echo $total_admin; ?></div>
            <a href="daftar_user.php" class="btn btn-sm btn-warning" style="margin-top:10px;">Lihat Users</a>
        </div>
    </div>
